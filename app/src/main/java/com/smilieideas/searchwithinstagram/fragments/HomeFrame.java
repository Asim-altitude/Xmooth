...
import com.smilieideas.searchwithinstagram.Constants;
...
public class HomeFrame extends Fragment  implements OnTrendSelected, OnItemClick
{
        ...
        asyncHttpClient.get(getActivity(), "https://www.instagram.com/explore/tags/"+tag+"/?__a=1", new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    searchDataAdapter.setOnItemClickListner(HomeFrame.this);
